...
import com.gleb.wrapper.UserWrapperService;
    ...
    SecurityWebFilterChain springWebFilterChain(ServerHttpSecurity http,
        ...
        return http.csrf(ServerHttpSecurity.CsrfSpec::disable)
                ...
                .authorizeExchange(it -> it
                        ...
                        .pathMatchers("/feed/moderatorFeed/disapprove/{id}").access((authentication, object) -> isModerator(authentication))
                        .pathMatchers("/posts/{postId}/comments/commentPost").authenticated()
                        .pathMatchers("/posts/{postId}/comments/myComments").authenticated()
                        .pathMatchers("/posts/{postId}/comments/deleteMyComment/{commentIdForPost}").authenticated()
                        ...
                        .pathMatchers("/chat/sendMessage").authenticated()
                        .pathMatchers("/chat/history/{contact}").authenticated()
                        .pathMatchers("/me/ban/{username}").authenticated()
                        .pathMatchers("/me/unban/{username}").authenticated()
                        .pathMatchers("/me/bannedBy").authenticated()
                        .pathMatchers("/me/bannedByMe").authenticated()
